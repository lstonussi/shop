    ...
    try {
      ...
      await showDialog<Null>(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: Text(
              //e.toString(),
              //Sempre colocar um erro amigavel, assi não expoe info sensiveis aos users
              //Pode criar um codigo unico do erro e fazer um cadastro de erros
              //e tbm criar um report ai sim manda o erro cru
